frappe.pages['buyer-dashboard'].on_page_load = function(wrapper) {
    ...
    $('<button class="btn btn-purple btn-sm mr-2 mb-2">BBJ Delivery Status (Bulk)</button>').appendTo(bbj_section);
    $('<button class="btn btn-purple btn-sm mr-2 mb-2">BBJ - Delivery Status Update Report (QA)</button>').appendTo(bbj_section);
